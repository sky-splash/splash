      ...
      <div className="flex flex-col lg:flex-row w-full h-full px-5 lg:px-7">
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2 relative px-8 lg:px-[6rem] xxl:px-[9rem] mt-20 lg:mt-0">
          ...
          <img
            src={ice1}
            alt="Ice 1"
            className="absolute bottom-[-1rem] sm:bottom-[5rem] md:bottom-[-2rem] lg:bottom-[6rem] xxl:bottom-[9rem] left-8 md:left-14 lg:left-8 z-0 w-[30%] sm:w-[40%] lg:w-[35%] xxl:w-[100%]"
          />
          <img
            src={ice2}
            alt="Ice 2"
            className="absolute bottom-[-1rem] sm:bottom-[4rem] md:bottom-[-2rem] lg:bottom-[5rem] xxl:bottom-[9rem] left-[6rem] sm:left-[7rem] md:left-[15rem] lg:left-[9rem] xxl:left-[12rem] z-20 w-[15%] sm:w-[20%] md:w-[12%] lg:w-[15%] xxl:w-[100%]"
          />
          <img
            src={ice3}
            alt="Ice 3"
            className="absolute bottom-[-1rem] sm:bottom-[4rem] md:bottom-[-2rem] lg:bottom-[5rem] xxl:bottom-[9rem] right-[7rem] sm:right-[6rem] md:right-[16rem] lg:right-[8rem] xxl:right-[12rem] z-20 w-[15%] sm:w-[20%] md:w-[12%] lg:w-[15%] xxl:w-[100%]"
          />
          <img
            src={ice4}
            alt="Ice 4"
            className="absolute bottom-[-1rem] sm:bottom-[5rem] md:bottom-[-2rem] lg:bottom-[6rem] xxl:bottom-[9rem] right-8 md:right-20 lg:right-8 z-0 w-[30%] sm:w-[35%] lg:w-[35%] xxl:w-[100%]"
          />
        </div>
      </div>
    </div>
