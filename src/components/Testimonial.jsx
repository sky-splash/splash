...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "https://randomuser.me/api/portraits/men/15.jpg", // Example avatar URL
    rating: 5,
  },
];
      ...
      <div className="bg-blue-950 text-white rounded-[3rem] p-8">
        ...
        <div className="flex flex-row gap-8 justify-center">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white text-blue-950 p-6 rounded-lg shadow-md flex flex-col gap-4 w-[300px]">
